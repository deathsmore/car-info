...
RUN dotnet restore "src/Apis/DVG.AP.Cms.CarInfo.Api/DVG.AP.Cms.CarInfo.Api.csproj"  -s http://2.2.2.90:8083/v3/index.json || dotnet restore "src/Apis/DVG.AP.Cms.CarInfo.Api/DVG.AP.Cms.CarInfo.Api.csproj" -s https://api.nuget.org/v3/index.json
COPY . .
